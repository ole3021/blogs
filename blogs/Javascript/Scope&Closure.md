...
_Engine_ will compile code before it interprets it. and the _Compiler_'s compilation phase was to find and associate all declarations with their appropriate scopes. And that results
